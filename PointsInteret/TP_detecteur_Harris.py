...
adresse_image="TP_images\\image027.ssech4.tif"
adresse_enregistrement_points="TP_images\\image027.ssech4.txt"
adresse_enregistrement_mesure_harris="TP_images\\R.tif"
adresse_enregistrement_image_points="TP_images\\impts.tif"


I=skimage.io.imread(adresse_image)
I=np.array(I,float)
[R,pts,impts]=Harris(I,sigma,k,seuil)
print (np.shape(pts)[0])+" points"
